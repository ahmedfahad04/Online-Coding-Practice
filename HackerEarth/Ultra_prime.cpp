...
/*
1. which dont satisfy condition ...put -1 there
2. find max, min of prime
3. if no element is not prime, then decide what to do
4. optimization
5. **** precount all range of prime number using COUNTS.******
